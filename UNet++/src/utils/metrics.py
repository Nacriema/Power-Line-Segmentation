...
"""
Created on Jun 20 19:31:44 2022
...
class RunningMetrics:
    ...
    def _fast_hist(self, label_true, label_pred):
        # XXX: Bugs when the label_true: float32, but label_pred int64
        # Message: TypeError:Cannot cast array data from dtype('float64') to dtype('int64') according to the rule 'safe'
        hist = np.bincount(self.n_classes * label_true.astype(np.int64) + label_pred,
